...
TEMPLATE_PATH="${WORK_DIR}/template/slide_image_prompts.yaml"
PY_SCRIPT="${WORK_DIR}/01_workflow/scripts/generate_images.py"
REQ_FILE="${WORK_DIR}/01_workflow/scripts/requirements.txt"
